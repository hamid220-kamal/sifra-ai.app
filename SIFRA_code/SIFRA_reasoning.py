...
from SIFRA_google_search import google_search, get_current_datetime
from SIFRA_get_weather import get_weather
from SIFRA_window_CTRL import open_app, close_app, folder_file
from SIFRA_file_opener import Play_file
